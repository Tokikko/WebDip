...
<div class= "container">
	<div class = "row text-center">
		<div class = "col-lg-11">
                <div id="dodajOvdjeStatiskitaRuta" name="dodajOvdjeStatiskitaRuta">
                            
                 
                  </div>
                     <button type="submit" id ="btnRutaStatistika"  name="btnRutaStatistika" class="btn btn-info" >Statistika ruta</button>               
                            
                     <center> <div id="chart1" name="chart" style="width:90%; height:400px;">
