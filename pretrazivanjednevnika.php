...
$baza = new baza();
$baza->spojiBaza();
$tablica = "<div class='table-responsive'><table id='ispisKorisnikaPD' class='table table-striped table-bordered dataTable DTTT_selectable' ><caption >Dnevnik</caption><thead><tr><th>Opis</th><th>Vrijeme</th><th>Korisnik</th></thead><tbody>";
