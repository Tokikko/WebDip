...
if($_SESSION['tipkorisnika'] ==  3){
	...
	<a href = "#" class = "dropdown-toggle" data-toggle = "dropdown">Reg korisnik <b class = "caret"></b></a>
		<ul class = "dropdown-menu">
                 ...
                 <li><a href = "registriranislanje.php" >Slanje paketa</a></li>
                 <li><a href = "usporedivanjeruta.php" >Usporedi rute</a></li>
                 <li><a href = "registriranistatuspaketa.php" >Lokacija paketa</a></li>
                </ul>
		</li>';
}

if(isset($_POST['btnDodajPaket'])){
    $baza = new baza();
    $baza->spojiBaza();
    $ime = $_POST['trazikorisnickoime'];;
    $prezime = $_POST['trazikorisnickoprezime'];;
    $adresa = $_POST['trazikorisnickoadresa'];;
    $grad = $_POST['trazikorisnickograd'];;
    $id= $_SESSION['id_korisnik'];
    $tip = $_POST['trazikorisnicpaket'];;
    $sluzba = $_POST['trazikorisniciSluzba'];
    $upit = "INSERT INTO paketZahtjev  (ime, prezime, adresa, status, korisnik, grad, tipPaket, sluzba,vrijeme) values ('$ime', '$prezime', '$adresa', '0', '$id','$grad', '$tip', '$sluzba', now())";        
		...
		<div class  = "modal-header text-center ">
			<h2> Slanje paketa </h2>
                        ...
                        <div class = "form-group" >
                            <label for = "trkorisnickoime" class = "col-lg-4 ">Korisnicko ime:</label>
                            <div  class = "col-lg-8">
                            <input type = "text" class = "form-control" id = "trkorisnickoime" name = "trkorisnickoime" >
                            </div>
                      
                        
                        </div>
                        <div id="dodajOvdje" name="dodajOvdje">
