...
<div class= "container">
	<div class = "row text-center">
		<div class = "col-lg-11">
                <div id="statiskiaPoslaniPaketi" name="statiskiaPoslaniPaketi">
                    <p>Od</p><input type=text id="datepickerXY" name="datepickerXY" >
                    <p>Do</p><input type=text id="datepickerXZ" name="datepickerXZ" >
                    <p></p><button type="submit" id ="btnTablicaXZ"  name="btnTablicaXZ" class="btn btn-info" >Pretraga</button>
                  </div>
                <button type="submit" id ="btnKorisnikStatistika"  name="btnKorisnikStatistika" class="btn btn-info" >Statistika korisnici</button>               
                            
                     <center> <div id="chart3" name="chart3" style="width:90%; height:400px;">
