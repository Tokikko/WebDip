...
<div class= "container">
	<div class = "row text-center">
		<div class = "col-lg-11">
                ...
                <div id="tablicaMjestoMail" name ="tablicaMjestoMail">
                    
                </div>
                    
                    <center><button type=submit id ="btnPosaljiSvima"  name="btnPosaljiSvima" class='btn btn-success' >Posalji svima</button></center>
