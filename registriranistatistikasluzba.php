...
if($_SESSION['tipkorisnika'] ==  3){
	...
	<a href = "#" class = "dropdown-toggle" data-toggle = "dropdown">Reg korisnik <b class = "caret"></b></a>
		<ul class = "dropdown-menu">
                 ...
                 <li><a href = "registriranislanje.php" >Slanje paketa</a></li>
                 <li><a href = "usporedivanjeruta.php" >Usporedi rute</a></li>
                 <li><a href = "registriranistatuspaketa.php" >Lokacija</a></li>
                </ul>
		</li>';
}
?>
...
<div class= "container">
	<div class = "row text-center">
		<div class = "col-lg-11">
                <div id="dodajOvdjeStatiskitaSluzbe" name="dodajOvdjeStatiskitaSluzbe">
                            
                 
                  </div>
                     <button type="submit" id ="btnSluzbaStatistika"  name="btnSluzbaStatistika" class="btn btn-info" >Statistika ruta</button>               
                            
                     <center> <div id="chart" name="chart" style="width:90%; height:400px;">
